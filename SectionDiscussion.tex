...
In this section, we discuss the five HMSFRs that do not.
...
The five HMSFRs, indicated in orange, that are clearly separated from the rest are the catastrophic outliers. 
