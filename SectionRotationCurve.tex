...
Since we have measurements over large ranges in Galactic longitude and heliocentric radius, we can attempt to infer not only $V_\phi$ and $V_R$ but also $\RGC$, $V_{\phi, \odot}$, and $V_{}
