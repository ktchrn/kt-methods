...
We believe that the cause of this variation is global model misspecification --- we have assumed that deviations from the rotation curve are spatially uncorrelated when they are in fact correlated, an over quite large spatial scales. 
We will discuss this issue further in Section \ref{sec:rotation_discussion}. 

The best-fit piecewise-linear rotation curve is shown in Figure \ref{rotation_curves}, with the CITET CLEMENS rotation curve for comparison. 
