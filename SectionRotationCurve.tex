...
We are trying to infer the Galactic ISM's rotation curve, $V_\phi (\RGC)$, whose functional form we will specify later. 
...
\begin{equation}
\label{eqn:vlos_mean}
\vlos(\glon, d) = \frac{V_\phi (\RGC) R_\odot \sin\glon}{\RGC}  - V_{\phi, \odot} \sin \glon + V_{R, \odot} \cos \glon.
\end{equation}
