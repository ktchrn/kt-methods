...
This method is a variation on CfA&Reid's extension of the kinematic distance method.
The kinematic distance method assumes that the on-sky position and line-of-sight velocity can be mapped to a distance by inverting the galactic rotation curve.
