...
They are not unique in directions where different distances are assigned the same line-of-sight velocity.
When a flat rotation curve is assumed, this affects sight lines inside the solar circle and towards the galactic anti-center. 
