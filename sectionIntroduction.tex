...
For many of these open problems, a measurement of the 1-velocity field, the line-of-sight velocity as a function of 3D position, would be enough to make non-trivial progress. 

The only measurements of 3D gas velocities have been of point-like gaseous structures, such as masers and ultracompact HII regions CITE.
Since non-line-of-sight velocities are derived from proper motions measurements, which cannot currently be made for extended sources, observationally derived 3-velocity fields are unlikely to materialize any time soon.

Even a less-ambitious line-of-sight velocity field as a function of 3D position (a 1-velocity field) could lead to 
